...
const object_type_settings:objectTypeSetting[] = [
    {
        ...
        animation_patterns: [
            { name: "open", frames: [12, 8, 4, 0], loop: false, interval: object_interval_fast },
            { name: "close", frames: [0, 4, 8, 12], loop: false, interval: object_interval_fast, default: true },
        ],
    }, {
...
const object_settings:object_setting[] = [
    ...
    { type: "door", name: "door_wood1_bright", animation_offset: 16 },
    { type: "door", name: "door_wood2", animation_offset: 1 },
    { type: "door", name: "door_wood2_bright", animation_offset: 17 },
    { type: "door", name: "door_wood3", animation_offset: 2 },
    { type: "door", name: "door_wood3_bright", animation_offset: 18 },
    { type: "door", name: "door_iron",  animation_offset: 3 },
    { type: "door", name: "door_iron_bright", animation_offset: 19 },
    ...
    { type: "switch",   name: "lamp",      animation_offset: 12, collision_x: 8, collision_y: 19, collision_w: 9, collision_h: 12 },
