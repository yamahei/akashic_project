window.gLocalAssetContainer["CharEntity"] = function(g) { (function(exports, require, module, __filename, __dirname) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.CharEntity = void 0;
...
// attack
{
  direction: "back",
  action: "attack",
  frames: [1, 0, 1, 2, 1, 0, 1, 2],
  loop: false,
  interval: char_interval_fast
}, {
  direction: "right",
  action: "attack",
  frames: [4, 3, 4, 5, 4, 3, 4, 5],
  loop: false,
  interval: char_interval_fast
}, {
  direction: "fore",
  action: "attack",
  frames: [7, 6, 7, 8, 7, 6, 7, 8],
  loop: false,
  interval: char_interval_fast
}, {
  direction: "left",
  action: "attack",
  frames: [10, 9, 10, 11, 10, 9, 10, 11],
  loop: false,
  interval: char_interval_fast
},
// die
...
class CharEntity extends g.E {
   ...
   */
  constructor(param, sprite, hitarea, effect) {
    super(param);
    this.direction = "fore";
    this.action = "stop";
    this.mental = "normal";
    this.mental_counter = 0; //frame
    this.damage_counter = 0; //frame
    this.sprite = sprite;
   ...
   */
  setMental(mental, mentaling_sec = default_mentaling_sec) {
    this.mental = mental;
   ...
   */
  setDamage(damaging_sec = default_damagling_sec) {
